 ...
 */
package com.practice.test2.deployment.core.models;
...
import com.practice.test2.deployment.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "practicetest2/components/helloworld");
